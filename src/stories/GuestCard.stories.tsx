...
const meta: Meta<typeof GuestCard> = {
    ...
    docs: {
      description: {
        component:
          ...
          "- **headerType**: 헤더 우측 아이콘 종류(`iconType`)와 클릭 핸들러(`onIconClick`)를 포함합니다.\n" +
  ...
  argTypes: {
    ...
    headerType: {
      ...
      table: {
        type: {
          summary: "{ iconType: 'scrap' | 'menu'; onIconClick: () => void }",
        },
      },
    },
  },
...
export const New: Story = {
  args: {
    ...defaultArgs,
    isNew: true,
    headerType: { iconType: "scrap", onIconClick: () => {} },
  },
};
...
export const HideView: Story = {
  args: {
    ...defaultArgs,
    isNew: false,
    headerType: { iconType: "menu", onIconClick: () => {} },
  },
};
